      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div onClick={() => navigate('/teacher')} style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', flexShrink: 0 }}>
            ...
            <span style={{ fontSize: 12, fontWeight: 500, color: '#94a3b8', background: '#f1f5f9', padding: '2px 8px', borderRadius: 4 }}>
              教师端
            </span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            {navItems.map((item) => (
              <button key={item.path} className={`tn-nav-link${isActive(item.path) ? ' tn-active' : ''}`}
