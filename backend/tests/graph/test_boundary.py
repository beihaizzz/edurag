...
# ═══════════════════════════════════════════════════════════════
# route_after_rag_search  tests
# ═══════════════════════════════════════════════════════════════

class TestRouteAfterRagSearch:
    """Routing from rag_search node: results, web fallback, or reject."""
    ...
    def test_has_results_only_routes_to_build_context(self):
        ...
        result = route_after_rag_search({"has_internal_results": True})
        assert result == "build_context"
    ...
    def test_missing_keys_routes_to_reject(self):
        ...
        result = route_after_rag_search({"question": "anything"})
        assert result == "reject"
...
class TestRoutingEdgeCases:
    ...
    def test_all_routers_handle_empty_state_gracefully(self):
        ...
        assert isinstance(route_after_rag_search({}), str)
    ...
    def test_route_after_rag_search_has_results_overrides_web(self):
    ...
    def test_full_success_path(self):
        ...
        r2 = route_after_rag_search({"has_internal_results": True})
